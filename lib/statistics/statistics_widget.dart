                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                't4wa6xjg' /* Check latest statistics */,
                              ),
                              textAlign: TextAlign.center,
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                ...
                                builder: (context) =>
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    List<WaterPointsRecord>
                                        pageViewWaterPointsRecordList =
                                        snapshot.data!;
                                    // Return an empty Container when the item does not exist.
                                    if (snapshot.data!.isEmpty) {
                                      return Container();
                                    }
                                    final pageViewWaterPointsRecord =
                                        pageViewWaterPointsRecordList.isNotEmpty
                                            ? pageViewWaterPointsRecordList
                                                .first
                                            : null;
                                    return Container(
                              ...
                              InkWell(
                                onTap: () async {
                                  await Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => AlertsListWidget(),
                                    ),
                                  );
                                },
                                child: Container(
                        ...
                        AuthUserStreamWidget(
                          builder: (context) =>
                            ...
                            stream: queryRegionRecord(
                              queryBuilder: (regionRecord) => regionRecord
                                  .where('country',
                                      isEqualTo: valueOrDefault(
                                          currentUserDocument?.country, ''))
                                  .orderBy('nbWater_points'),
                            ),
                            builder: (context, snapshot) {
                              // Customize what your widget looks like when it's loading.
                              if (!snapshot.hasData) {
