...
import 'alert_details_model.dart';
export 'alert_details_model.dart';

class AlertDetailsWidget extends StatefulWidget {
  const AlertDetailsWidget({
    Key? key,
    this.post,
  }) : super(key: key);

  final AlertsRecord? post;

  @override
  _AlertDetailsWidgetState createState() => _AlertDetailsWidgetState();
}

class _AlertDetailsWidgetState extends State<AlertDetailsWidget>
    with TickerProviderStateMixin {
  late AlertDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AlertDetailsModel());
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'vpkbquyc' /* Lorem ipsum dolor sit amet, co... */,
                          ),
                          style: FlutterFlowTheme.of(context)
                              .bodySmall
                              .override(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    '9qjvwagc' /* I'm not really sure about this... */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodySmall
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'lfqn79s2' /* I'm not really sure about this... */,
                                                ),
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodySmall
